...
public class ActionH2 extends ActionTable {
    ...
    public String getCreateSyntax() {
        return "CREATE TABLE IF NOT EXISTS " + getTableName() + " (" + "actID INTEGER AUTO_INCREMENT PRIMARY KEY," + "actName TEXT," + "actPlugin TEXT," + "actCategory INTEGER," + "actDescription TEXT," + "PRIMARY KEY(actID)" + ");" + "CREATE UNIQUE INDEX IF NOT EXISTS idxActionName ON " + getTableName() + "(actName)";
    }
